...
export default function Hero() {
  ...
  return (
    <section id="home" className="pt-20 pb-16 bg-gradient-to-br from-red-50 via-gray-50 to-black/5">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-4xl mx-auto mb-12">
          <Badge className="mb-4 bg-red-100 text-[#dd3333] hover:bg-red-100">
            🚀 Empowering West Africa's Financial Future
          </Badge>
          
          <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-[#dd3333] to-[#000000] bg-clip-text text-transparent">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
            {[
              ...
              <Card key={index} className="p-4 text-center hover:shadow-lg transition-shadow">
                <feature.icon className="w-8 h-8 mx-auto mb-2 text-[#dd3333]" />
